...
こちらの雛形は有志のMisskeyユーザーによって協力して作成、更新を行っております。  
規約のプロジェクトは以下のページに設置しておりますので、アイデア、改善点などがございましたらご参加頂けますと幸いです。

https://github.com/CAT5NEKO/misKiyaku.git
